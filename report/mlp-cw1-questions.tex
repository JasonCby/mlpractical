...
\youranswer{Overfitting is a phenomenon that model has too good results on the training set and not so good results on the test set (even with the progress of learning epochs, the accuracy rate decreases).}
}
